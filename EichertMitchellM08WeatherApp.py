...
# Functions below to fetch and display weather info
...
def showWeather():
    ...
    api_key = "f9eea37c6735496593a2bb79b1245106"  #my API
...
def main_screen():
    ...
    #icon
    image_icon=PhotoImage(file="LoginIcon.png")
